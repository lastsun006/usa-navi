      ...
      await replyToLine(replyToken, [
        {
          type: "text",
          text: [
            "アメリカ旅行中の困りごと、全部サポートします！",
            "",
            "📍場所・移動系",
            "レストラン検索/営業時間確認/ルート案内/Uber料金目安/駐車場情報",
            "",
            "🍔食事・お土産",
            "家族向けレストラン提案/アメリカ体験グルメ/お土産選び/予算相談",
            "",
            "🎢観光プラン",
            "エリア別おすすめ/家族で楽しめるスポット/時間配分",
            "",
            "🆘トラブル対応",
            "病院の行き方/警察への連絡/盗難時の手順/使える英語フレーズ",
            "",
            "💡現地知識",
            "チップの払い方/アメリカのマナー/やっちゃダメなこと",
            "",
            "📸写真を送るだけでも",
            "バーコード・商品写真 → 成分・値段を日本語で解説",
            "看板・メニュー・レシート → 日本語訳＋アドバイス",
            "現在地の位置情報 → 治安をLAPDデータで評価",
            "",
            "📞代行サービス",
            "レストラン予約（英語で電話代行）/荷物の日本発送",
            "",
            "普通に話しかけてください👇",
            "「今ベニスビーチ、お腹空いた」",
            "「明日ディズニー行く、近くでホテル取れる？」",
